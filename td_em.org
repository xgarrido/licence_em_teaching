...
2) *Impulsion*
   ...
   2) La variation d'impulsion $\vv{p}$ par unité de temps est égale à la force
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          \vv{p}&=\int_0^T\frac{q}{c}\left(\vv{v}.\vv{E}\right)\vv{u}_zdt-\int_0^T\frac{q}{c}\left(\vv{v}.\vv{u}_z\right)\vv{E}dt
        \end{align*}
      #+END_SRC
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          \vv{p}=\int_0^T\frac{q}{c}\left(\vv{v}.\vv{E}\right)\vv{u}_zdt=\frac{W}{c}\vv{u}_z
        \end{align*}
      #+END_SRC
...
3) *Moment cinétique* $\sigma_z=\vv{OM}\times\vv{p}$
   ...
   2) $\vv{p}=\tfrac{W}{c}\vv{u}_z$
      #+BEGIN_SRC latex
        \begin{align*}
          \left.\vv{\sigma}_z\right|_O&=\vv{OM}\times\vv{p}=\vv{OM}\times\frac{W}{c}\vv{u}_z\\
          \left.\vv{\sigma}_z\right|_A&=\vv{AM}\times\vv{p}=\underbrace{\vv{AO}}_{\parallel\vv{u}_z}\times\frac{W}{c}\vv{u}_z+\vv{OM}\times\frac{W}{c}\vv{u}_z\\
          &=\left.\vv{\sigma}_z\right|_O
        \end{align*}
      #+END_SRC
* Footnotes
