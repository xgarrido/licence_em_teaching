...
1) $V(r=R)=0$
   1) L'absence de charges libres dans le volume d'un conducteur (les charges
      ...
      #+BEGIN_SRC latex
        ...
        \end{align*}
      #+END_SRC
   2) En raison de la symétrie du problème, une charge fictive $q^\prime$ est
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          V(M)=\frac{1}{4\pi\epsilon_0}\left(\frac{q}{PM}+\frac{q^\prime}{P^\prime M}\right)
        \end{align*}
      #+END_SRC
      où $P^\prime$ est la position de la charge $q^\prime$. Le potentiel pour
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          \frac{q}{PM}=-\frac{q^\prime}{P^\prime M}
        \end{align*}
      #+END_SRC
      $q^\prime$ est donc de signe opposé à $q$. Par suite, on déduit que
      #+BEGIN_SRC latex
        \begin{align*}
          q\,P^\prime M &= -q^\prime\,PM\\
          q^2\,P^\prime M^2 &=q^{\prime2}\,PM^2\\
          q^2\,\vv{P^\prime M}^2 &=q^{\prime2}\,\vv{PM}^2\\
          q^2\,\left(\vv{P^\prime O}+\vv{OM}\right)^2 &=q^{\prime2}\,\left(\vv{PO}+\vv{OM}\right)^2\\
          \underbrace{q^2P^\prime O^2-q^{\prime2}PO^2+q^2R^2-q^{\prime2}R^2}_{\text{\ding{192}}}&=\underbrace{q^{\prime2}2\vv{PO}.\vv{OM}-q^22\vv{P^\prime O}.\vv{OM}}_{\text{\ding{193}}}
        \end{align*}
      #+END_SRC
      ...
      ainsi \ding{192}=\ding{193}=0 et on déduit
      #+BEGIN_SRC latex
        \begin{align*}
          \text{\ding{193}}=0&=2\vv{OM}.\left(q^{\prime2}\vv{PO}-q^2\vv{P^\prime O}\right)\\
          \vv{P^\prime O}&=\frac{q^{\prime2}}{q^2}\vv{PO}\parallel\vv{u}_z
        \end{align*}
      #+END_SRC
      À partir du premier membre \ding{192}, on déduit
      #+BEGIN_SRC latex
        \begin{align*}
          \text{\ding{192}}=0&=q^2P^\prime O^2-q^{\prime2}PO^2+q^2R^2-q^{\prime2}R^2\\
          R^2\left(q^{\prime2}-q^2\right)&=q^2P^\prime O^2-q^{\prime2}PO^2\\
          &=q^2\times\frac{q^{\prime4}}{q^4}PO^2-q^{\prime2}PO^2\\
          &=q^{\prime2}PO^2\left(\frac{q^{\prime2}}{q^2}-1\right)\\
          R^2&=PO^2\times\left(\frac{q^\prime}{q}\right)^2\\
          q^\prime&=-\frac{qR}{PO}\\
          P^\prime O&=\frac{R^2}{PO}\leq R
        \end{align*}
      #+END_SRC
   3) À partir de l'équation locale $\div\vv{E}=\tfrac{\rho}{\epsilon_0}$ et de
      ...
      la situation "charge $q$ + charge $q^\prime$" du fait que les deux
   ...
   4) Calcul du champ $\vv{E}(r\geq R)$ : combinaison des champs coulombiens de
      chacune des charges $q$ et $q^\prime$
      #+BEGIN_SRC latex
        \begin{align*}
          \vv{E}(M)&=\frac{1}{4\pi\epsilon_0}\left(\frac{q}{PM^3}\vv{PM}+\frac{q^\prime}{P^\prime M^3}\vv{P^\prime M}\right)\\
          &=\frac{1}{4\pi\epsilon_0}\left[\left(\frac{q}{PM^3}+\frac{q^\prime}{P^\prime M^3}\right)\vv{OM}+\underbrace{\frac{q\vv{PO}}{PM^3}+\frac{q^\prime\vv{P^\prime O}}{P^\prime M^3}}_{\text{\ding{192}}}\right]
        \end{align*}
      #+END_SRC
      Sachant que $\vv{P^\prime O}=\frac{q^{\prime2}}{q^2}\vv{PO}$ et $P^\prime
      M=-\frac{q^\prime}{q}PM$, l'expression \ding{192} devient
      #+BEGIN_SRC latex
        \begin{align*}
          \text{\ding{192}}&=\frac{q\vv{PO}}{PM^3}+\frac{q^\prime\vv{P^\prime O}}{P^\prime M^3}\\
          &=\frac{q\vv{PO}}{PM^3}+\frac{q^\prime\times q^{\prime2}}{q^2}\times\frac{\vv{PO}}{-q^{\prime3}}\times\frac{q^3}{PM^3}\\
          &=0
        \end{align*}
      #+END_SRC
      ...
      #+BEGIN_SRC latex
        \begin{align*}
          \vv{E}(M)&=\frac{R\vv{u}_r}{4\pi\epsilon_0}\left(\frac{q}{PM^3}+\frac{q^\prime}{P^\prime M^3}\right)\\
      ...
      charges à l'intérieur de la sphère. La charge fictive $q^\prime$ est par
      construction à l'intérieur de la sphère d'où $Q_\text{tot.}=q^\prime$.
   5) Calcul de la force exercée par la charge $q$ sur $q^\prime$ \equiv à
      calculer la force exercée par la charge $q$ sur la boule conductrice.
      #+BEGIN_SRC latex
        \begin{align*}
          \vv{F}_{q\to q^\prime}&=\vv{F}_{q\to\text{boule}}\\
          &=q^\prime\vv{E}_{q\to q^\prime}\\
          &=\frac{q^\prime q}{4\pi\epsilon_0}\times\frac{\vv{PP^\prime}}{PP^{\prime3}}=\frac{q^\prime q}{4\pi\epsilon_0}\times\frac{-\vv{u}_z}{PP^{\prime2}}\\
          &\text{avec }PP^{\prime2}=PO^2+OP^{\prime2}=PO^2+\frac{R^4}{PO^2}=\frac{PO^4+R^4}{PO^2}\\
          \vv{F}_{q\to\text{boule}}&=-\frac{qq^\prime}{4\pi\epsilon_0}\times\frac{PO^2}{PO^4+R^4}\vv{u}_z\\
